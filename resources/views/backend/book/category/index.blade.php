                                                   ...
                                                   @if (auth()->user()->usertype == 'admin')
                                                       @if ($category->user_id == Auth::user()->id || Auth::user()->usertype == 'admin')
                                                           <a href="javascript:void(0)" type="button"
                                                               class="btn tp-edit-btn edit_category_form"
       ...
       <div class="modal fade" id="createCategoryModal">
           <div class="modal-dialog modal-lg">
               <div class="modal-content">
                   <form action="{{ route('admin.book-categories.store') }}" id="categoryForm"
                           ...
                           <div class="card-body">
                               ...
                               <div class="form-group">
                                   ...
                                   <input type="file" class="form-control"
                                       accept="image/png, image/jpeg, image/jpg, image/svg+xml" name="svg"
                                       id="svg" />
                               </div>

                               <div>
                                   <img src="" alt="svg" class="svg_preview"
                   ...
                   <form id="EditcategoryForm" enctype="multipart/form-data" method="POST">
                       ...
                       <div class="modal-body">
                           ...
                           <div class="card-body">
                               ...
                               <div>
                                   <img src="" alt="svg" class="image_preview mb-2"
                                       style="width: 50px; height: 50px;display:none">
                               </div>
                               <div class="form-group">
                                   <label>Category Status</label>
                       ...
                       <div class="modal-footer justify-content-between">
                           <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                           <button type="submit" id="updateBtn" class="btn btn-primary">Update Category</button>
                       </div>
                   </form>
               </div>
           </div>
       ...
       <script>
           ...
           $(document).ready(function() {
               ...
               $(document).on('click', '#submitBtn', function(e) {
                   ...
                   $.ajax({
                       method: 'post',
                       url: "{{ route('admin.book-categories.store') }}",
                       data: formdata,
                       contentType: false,
                       processData: false,
           ...
           $(document).on('click', '#updateBtn', function(e) {
               ...
               $.ajax({
                   method: 'POST',
                   url: "{{ route('admin.book-categories.update', '') }}/" + id,
                   data: formdata,
                   contentType: false,
                   processData: false,
                   success: function(res) {
           ...
           $(document).on('click', '.delete_category', function(e) {
               ...
               Swal.fire({
                   ...
                   if (result.isConfirmed) {
                       ...
                       $.ajax({
                           url: "{{ route('admin.book-categories.destroy', '') }}/" + category_id,
                           method: 'DELETE',
                           data: {
                               id: category_id
                           },
