        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex items-center">
                    <a href="{{ route('admin.pages.homepage.banner.edit',$mainItem['id']) }}" class="btn tp-edit-btn mr-2">
                        <span>
                ...
                $(document).on('click', '.delete_item', function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: "{{ route('admin.pages.homepage.banner.delete')}}",
                                method: 'post',
                                headers: {
                                ...
                                success: function(res) {
                                    if (res.status == 'success') {
                                        ...
                                        window.location.href = "{{ route('admin.pages.homepage.banner') }}";
                                    }
                                }
                            });
                        }
