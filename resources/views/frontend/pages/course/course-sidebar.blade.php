<div class="course__sidebar pl-70">
        ...
        <form action="{{ route('course.search') }}" method="GET">
            ...
            <button type="submit">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                    y="0px" viewBox="0 0 584.4 584.4" style="enable-background:new 0 0 584.4 584.4;"
                    xml:space="preserve">
                    <g>
                        <g>
                            <path class="st0"
                    ...
                    <li>
                        <div class="course__sidebar-check mb-10 d-flex align-items-center">
                            <input class="m-check-input just_one_cat" name="category" type="checkbox"
                                id="m-all-course-{{ $courseCategory->id }}" value="{{ $courseCategory->id }}">
    ...
    @php
        $languages = App\Models\CourseLanguage::where('status', 'active')->get();
    @endphp
                        ...
                        <li>
                            <div class="course__sidebar-check mb-10 d-flex align-items-center">
                                <input class="m-check-input just_one_lang" name="language" type="checkbox"
                                    id="m-all-{{ $language->id }}" value="{{ $language->id }}">
                                <label class="m-check-label"
                                    for="m-all-{{ $language->id }}">{{ $language->title }}</label>
                            </div>
                        </li>
                    @endforeach
                </ul>
    ...
    <div class="course__sidebar-widget grey-bg">
        <div class="course__sidebar-info">
            ...
            <ul>
                <li>
                    <div class="course__sidebar-check mb-10 d-flex align-items-center">
                        <input class="m-check-input" name="level" type="checkbox" value="beginner" id="m-beginner">
                        <label class="m-check-label" for="m-beginner">Beginner</label>
                    </div>
                </li>
                <li>
                    <div class="course__sidebar-check mb-10 d-flex align-items-center">
                        <input class="m-check-input" name="level" type="checkbox" value="intermediate"
                            id="m-intermediate">
                ...
                <li>
                    <div class="course__sidebar-check mb-10 d-flex align-items-center">
                        <input class="m-check-input" name="level" type="checkbox" value="advanced" id="m-expert">
