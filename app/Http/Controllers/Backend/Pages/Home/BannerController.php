...
class BannerController extends Controller
{
    public function getBanner() {
        $banner = [];
        if(SystemSetting::where('key', 'banner')->exists()) {
            $bannerData = SystemSetting::where('key', 'banner')->first();
    ...
    public function index() {
        ...
        return view('backend.pages.home.banner.index', compact('banner'));
    }
    ...
    public function store(Request $request) {
       if($request->updateId != null) {
        ...
        //insert data 
        if(SystemSetting::where('key', 'banner')->exists()) {
            $banner = SystemSetting::where('key', 'banner')->first();
    ...
    public function edit($id) {
        ...
        return view('backend.pages.home.banner.index', compact('item', 'banner'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('admin.pages.homepage.banner')->with('success', 'Banner updated successfully');
}
