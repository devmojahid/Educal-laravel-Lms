...
(function ($) {
    ...
    $('.tp-course-grid-select select').niceSelect();
    ...
    $(".tp-course-active").on("click", function () {
        $(".lesson-details-side").addClass("tp-lesson-open");
    });
    $(".tp-course-close-btn").on("click", function () {
        $(".lesson-details-side").removeClass("tp-lesson-open");
    });
